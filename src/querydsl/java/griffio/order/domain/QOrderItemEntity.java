...
public class QOrderItemEntity extends EntityPathBase<OrderItemEntity> {
    ...
    private static final long serialVersionUID = -1130229244L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QOrderItemEntity orderItemEntity = new QOrderItemEntity("orderItemEntity");

    public final griffio.dao.domain.QAbstractPersistableSequence _super = new griffio.dao.domain.QAbstractPersistableSequence(this);
    ...
    public final griffio.product.domain.QProductEntity product;
    ...
    public QOrderItemEntity(Class<? extends OrderItemEntity> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.product = inits.isInitialized("product") ? new griffio.product.domain.QProductEntity(forProperty("product")) : null;
    }
